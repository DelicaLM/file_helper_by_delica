...
init_directory = os.path.join(project_directory, "file_helper_by_delica/")
...
autodoc2_packages = [
    "../../file_helper_by_delica/file_helper_funcs.py",
"../../tests/test_file_helper_funcs.py"
]
